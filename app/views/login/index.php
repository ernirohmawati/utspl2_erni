...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo BASEURL ?>index2.html">Uts Erni</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo BASEURL ?>LoginController/login" method="post">
        <div class="input-group mb-3">
          <input type="text" name="inputUser" class="form-control" placeholder="Email">
